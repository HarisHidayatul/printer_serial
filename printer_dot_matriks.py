...
p.text("Printing 200 dots horizontal and 5 dots vertical\n\n")

# Data bitmap untuk 200 dots horizontal dan 5 dots vertikal
bitmap_data = create_bitmap(200, 5)

# ESC/POS Command: Print raster bit image
# Format: ESC * m nL nH d1...dk
# m = Mode (0 = 8-dot single-density), nL = Width in bytes (200/8), nH = High byte (0)
p._raw(b'\x1B*\x00\x19\x00')  # ESC * 0 25 0 (200 dots / 8 = 25 bytes, 0x19 = 25, 0x00 = 0)
p._raw(bytes(bitmap_data))    # Data bitmap

# Feed kertas dan potong
p.text("\n\n")

print("200 dots horizontal and 5 dots vertical printed successfully!")
